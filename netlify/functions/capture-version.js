...
const { CAPTURE_VERSION, TRUSTED_VERSION, SPIN_ENABLED } = require('./lib/spin');

exports.handler = async function () {
  return {
    statusCode: 200,
    headers: { 'Content-Type': 'application/json', 'Cache-Control': 'no-store' },
    body: JSON.stringify({ version: CAPTURE_VERSION, trusted: TRUSTED_VERSION, enabled: SPIN_ENABLED }),
  };
};
